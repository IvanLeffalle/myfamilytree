...
document.addEventListener("DOMContentLoaded", function () {
    ...
    treeDiv.addEventListener("mousedown", function (e) {
        isDragging = true;
        offsetX = e.clientX - treeDiv.getBoundingClientRect().left;
        offsetY = e.clientY - treeDiv.getBoundingClientRect().top;
        treeDiv.style.cursor = "grabbing";
    });
